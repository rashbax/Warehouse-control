...
function SidebarInner({ onClose }: { onClose?: () => void }) {
  ...
  return (
    <aside className="w-60 h-full bg-slate-800 flex flex-col">
      {/* Logo */}
      <div className="px-4 py-5 border-b border-slate-700 flex items-center justify-between">
        <div className="flex items-center gap-3">
          ...
          <div>
            <p className="text-white font-semibold text-sm leading-tight">Склад</p>
            <p className="text-slate-400 text-xs">Учёт остатков</p>
          </div>
        </div>
        {onClose && (
          <button
  ...
  return (
    <>
      ...
      <button
        ...
        className="md:hidden fixed top-3 left-4 z-40 p-2 bg-slate-800 text-white rounded-lg shadow-lg"
